...
class SectionGenerator:
    ...
    def generate_section_summary(self, section_content: str) -> Optional[str]:
        """
        Creates a structured summary of a logical section of documentation.
        """
        max_chars = 10000
        content_to_send = section_content[:max_chars]
        prompt = SECTION_SUMMARY_PROMPT.format(section_content=content_to_send)
